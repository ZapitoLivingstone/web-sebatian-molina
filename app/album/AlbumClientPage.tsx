    ...
    <section className="w-full py-12 md:py-24 lg:py-32 flex items-center justify-center">
      ...
      >
        <motion.h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl mb-4" variants={itemVariants}>
          <span>{messages.albumTitle[language]}</span>
        </motion.h1>
        <motion.p className="max-w-[700px] mx-auto text-lg text-muted-foreground mb-10" variants={itemVariants}>
          <span>{messages.albumDescription[language]}</span>
        </motion.p>
        <motion.div variants={itemVariants}>
          <p className="text-xl text-primary">
            <span>¡Contenido del álbum próximamente! / </span>
            <span className="text-muted-foreground">Album content coming soon!</span>
          </p>
        </motion.div>
      </motion.div>
    </section>
