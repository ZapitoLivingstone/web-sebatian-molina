...
export const messages: Messages = {
  ...
  viewCV: { es: "Ver CV", en: "View CV" }, // Still used in About page button
  downloadCV: { es: "Descargar CV", en: "Download CV" }, // Can be removed if not used
  ...
  // About Page (Reverted to simpler version)
  ...
  // Removed: experience, education, activitiesAndGroups, focusedOn, contactInformation
